    ...
    declare namespace Db {
        ...
        namespace Consumer {
            ...
            namespace Consumer {
                ...
                export const OtherInformation: string;
        ...
        namespace Meter {
            ...
            namespace MeterDetail {
                ...
                export const Deleted: string;
                export const MeterAssignedLocation: string;
                export const MeterCommunicationMethod: string;
                export const MeterConsumerId: string;
                export const MeterDeleted: string;
                export const MeterDetailId: string;
                export const MeterId: string;
                export const MeterMake: string;
                export const MeterMeterTypeId: string;
                export const MeterName: string;
                export const MeterNotes: string;
                export const MeterPhysicalLocation: string;
                export const MeterRegistrationDate: string;
                export const MeterSerialCommunicationSetting: string;
                export const MeterSerialNumber: string;
                ...
                export const SchedulingDay: string;
                export const SchedulingDeleted: string;
                export const SchedulingFullDate: string;
                export const SchedulingId: string;
                export const SchedulingMonth: string;
                export const SchedulingTime: string;
                export const SchedulingYear: string;
                export const Value: string;
            }
        ...
        namespace Zoning {
            ...
            namespace Section {
                ...
                export const FloorDescription: string;
