    ...
    public class DefaultDB_20190101_130000_EMS : AutoReversingMigration
    {
        public override void Up()
        {
            ...
            Create.Table("MeterParameters")
                ...
                .WithColumn("ParameterGroupID").AsInt32().Nullable().ForeignKey("FK_MeterParameter_ParameterGroup", "dbo", "ParameterGroup", "ParameterGroupID")
                .WithColumn("ParameterID").AsInt32().Nullable().ForeignKey("FK_MeterParameter_Parameter", "dbo", "Parameter", "ParameterID")
                .WithColumn("Deleted").AsBoolean().NotNullable().WithDefaultValue(false);
            ...
            Insert.IntoTable("City")
                ...
                {
                    Name = "Aleppo",
                    Description = "The oldest city in the world"
                })
                .Row(new
                {
                    Name = "Damascus",
                    Description = "The second oldest city in the world"
                });
